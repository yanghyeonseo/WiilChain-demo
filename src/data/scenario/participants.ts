...
export const participantProfiles: ParticipantProfile[] = [
  ...
  { id: 'donor', name: '양도인', shortName: '양도인', category: '당사자', imageSrc: donorImage, imageScale: 1, imageOffsetYPercent: 4 },
  { id: 'assignee_1', name: '양수인 본인', shortName: '본인', category: '양수인 본인', imageSrc: assignee1Image, imageScale: 1, imageOffsetYPercent: 4 },
  { id: 'assignee_2', name: '타 양수인', shortName: '타 양수인', category: '타 양수인', imageSrc: assignee2Image, imageScale: 1, imageOffsetYPercent: 4 },
  { id: 'executor', name: '유언집행자', shortName: '집행자', category: '집행주체', imageSrc: executorImage, imageScale: 1, imageOffsetYPercent: 4 },
